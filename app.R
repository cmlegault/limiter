...
ui <- navbarPage("TRAC GBYT Limiter",
    ...
    tabPanel("Welcome",
      ...
      mainPanel(
        ...
        h3("Examples"),
        p("The examples shown are for demonstration purposes only. They are included to show how this app could be used to help decide on limits and quota, and potentially on reference points as well. There are numerous combinations of approaches and other approaches that could be used to set limits, quota, and potentially reference points."),
